...
import com.example.pertemuan_10.PendudukAdapter.PendudukHolder

class PendudukAdapter(var listPenduduk : ArrayList<String>, var db: SQLiteDatabase?): RecyclerView.Adapter<PendudukHolder>() {
